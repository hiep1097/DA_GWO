...
public class Main_GWO {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Grey_wolf_optimizer qbpso_cwt = new Grey_wolf_optimizer(ff_cwt, ff_cwt.Lower, ff_cwt.Upper, maxiter, N);
        Grey_wolf_optimizer qbpso_twc = new Grey_wolf_optimizer(ff_twc, ff_twc.Lower, ff_twc.Upper, maxiter, N);
